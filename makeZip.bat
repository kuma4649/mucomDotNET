...
del /Q .\output\NET5\PCMTool\*.*

del /Q .\output\playerx64\*.*
...
xcopy .\Player64\bin\x64\Release\*.*                   .\output\playerx64\     /E /R /Y /I /K
...
del /Q .\output\playerx64\*.pdb
del /Q .\output\playerx64\*.config
